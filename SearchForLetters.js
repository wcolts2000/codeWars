...
// output string to '1', otherwise to '0'. if 'b' or 'B' appears in the string, set the second character to '1', and
// so on for the rest of the alphabet.
